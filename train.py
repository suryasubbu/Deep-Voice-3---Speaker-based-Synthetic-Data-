    ...
    def __init__(self, training=True):
        ...
        with self.graph.as_default():
            ...
            if training:
                ...
                self.y1 = tf.compat.v1.placeholder(tf.float32, shape=(hp.batch_size, hp.Ty//hp.r, hp.n_mels*hp.r))
                self.prev_max_attentions_li = tf.compat.v1.placeholder(tf.int32, shape=(hp.dec_layers, hp.batch_size,))
            ...
            with tf.compat.v1.variable_scope("converter"):
                # Restore shape
...
if __name__ == '__main__':
    ...
    with g.graph.as_default():
        sv = tf.compat.v1.train.Supervisor(logdir=hp.logdir, save_model_secs=0)
